 ...
 */
export declare function execute<T>(signal: AbortSignal, executor: (resolve: (value: T) => void, reject: (reason?: any) => void) => (reason?: unknown) => void | PromiseLike<void>): Promise<T>;
