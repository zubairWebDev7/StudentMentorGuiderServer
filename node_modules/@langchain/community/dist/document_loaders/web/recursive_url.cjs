...
class RecursiveUrlLoader extends base_1.BaseDocumentLoader {
    ...
    extractMetadata(rawHtml, url) {
        ...
        const { document } = new jsdom_1.JSDOM(rawHtml, { virtualConsole }).window;
