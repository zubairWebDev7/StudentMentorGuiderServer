...
class WeaviateBatchStreamError extends WeaviateError {
    constructor(message) {
        super(`Batch stream failed with message: ${message}`);
    }
}
exports.WeaviateBatchStreamError = WeaviateBatchStreamError;
