import { ModuleConfig, RerankerCohereConfig, RerankerContextualAIConfig, RerankerJinaAIConfig, RerankerNvidiaConfig, RerankerVoyageAIConfig } from '../config/types/index.js';
declare const _default: {
     ...
     */
    cohere: (config?: RerankerCohereConfig) => ModuleConfig<"reranker-cohere", RerankerCohereConfig | undefined>;
    /**
     ...
     */
    contextualai: (config?: RerankerContextualAIConfig) => ModuleConfig<"reranker-contextualai", RerankerContextualAIConfig | undefined>;
    /**
     ...
     */
    jinaai: (config?: RerankerJinaAIConfig) => ModuleConfig<"reranker-jinaai", RerankerJinaAIConfig | undefined>;
    /**
     ...
     */
    nvidia: (config?: RerankerNvidiaConfig) => ModuleConfig<"reranker-nvidia", RerankerNvidiaConfig | undefined>;
    /**
     ...
     */
    voyageAI: (config?: RerankerVoyageAIConfig) => ModuleConfig<"reranker-voyageai", RerankerVoyageAIConfig | undefined>;
};
