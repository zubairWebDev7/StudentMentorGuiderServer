...
export declare const generativeParameters: {
     ...
     */
    contextualai(config?: GenerativeContextualAIConfigRuntime): ModuleConfig<"generative-contextualai", GenerativeConfigRuntimeType<"generative-contextualai"> | undefined>;
};
