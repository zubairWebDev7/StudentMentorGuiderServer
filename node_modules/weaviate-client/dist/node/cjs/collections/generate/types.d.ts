...
interface Bm25<T, V> {
     ...
     */
    bm25<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(query: string, generate: GenerateOptions<T, C>, opts?: BaseBm25Options<T, I>, callOpts?: CallOptions): Promise<GenerativeReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a keyword-based BM25 search of objects in this collection.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/bm25) for a more detailed explanation.
     ...
     */
    bm25<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(query: string, generate: GenerateOptions<T, C>, opts: GroupByBm25Options<T, I>, callOpts?: CallOptions): Promise<GenerativeGroupByReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a keyword-based BM25 search of objects in this collection.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/bm25) for a more detailed explanation.
     ...
     */
    bm25<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(query: string, generate: GenerateOptions<T, C>, opts?: Bm25Options<T, I>, callOpts?: CallOptions): GenerateReturn<T, RV, C>;
}
interface Hybrid<T, V> {
     ...
     * @return {Promise<GenerativeReturn<T, V, C>>} - The results of the search including the generated data.
     */
    hybrid<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(query: string, generate: GenerateOptions<T, C>, opts?: BaseHybridOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of an object search in this collection using the hybrid algorithm blending keyword-based BM25 and vector-based similarity.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/hybrid) for a more detailed explanation.
     ...
     * @return {Promise<GenerativeGroupByReturn<T, V, C>>} - The results of the search including the generated data grouped by the specified properties.
     */
    hybrid<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(query: string, generate: GenerateOptions<T, C>, opts: GroupByHybridOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeGroupByReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of an object search in this collection using the hybrid algorithm blending keyword-based BM25 and vector-based similarity.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/hybrid) for a more detailed explanation.
     ...
     * @return {GenerateReturn<T, V, C>} - The results of the search including the generated data.
     */
    hybrid<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(query: string, generate: GenerateOptions<T, C>, opts?: HybridOptions<T, V, I>, callOpts?: CallOptions): GenerateReturn<T, RV, C>;
}
interface NearMedia<T, V> {
     ...
     * @return {Promise<GenerativeReturn<T, V, C>>} - The results of the search including the generated data.
     */
    nearMedia<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(media: string | Buffer, type: NearMediaType, generate: GenerateOptions<T, C>, opts?: BaseNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a by-audio object search in this collection using an audio-capable vectorization module and vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/modules/retriever-vectorizer-modules/multi2vec-bind) for a more detailed explanation.
     ...
     * @return {Promise<GenerativeGroupByReturn<T, V, C>>} - The results of the search including the generated data grouped by the specified properties.
     */
    nearMedia<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(media: string | Buffer, type: NearMediaType, generate: GenerateOptions<T, C>, opts: GroupByNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeGroupByReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a by-audio object search in this collection using an audio-capable vectorization module and vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/modules/retriever-vectorizer-modules/multi2vec-bind) for a more detailed explanation.
     ...
     * @return {GenerateReturn<T, V, C>} - The results of the search including the generated data.
     */
    nearMedia<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(media: string | Buffer, type: NearMediaType, generate: GenerateOptions<T, C>, opts?: NearOptions<T, V, I>, callOpts?: CallOptions): GenerateReturn<T, RV, C>;
}
interface NearObject<T, V> {
     ...
     * @return {Promise<GenerativeReturn<T, V, C>>} - The results of the search including the generated data.
     */
    nearObject<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(id: string, generate: GenerateOptions<T, C>, opts?: BaseNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a by-object object search in this collection using a vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/api/graphql/search-operators#nearobject) for a more detailed explanation.
     ...
     * @return {Promise<GenerativeGroupByReturn<T, V, C>>} - The results of the search including the generated data grouped by the specified properties.
     */
    nearObject<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(id: string, generate: GenerateOptions<T, C>, opts: GroupByNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeGroupByReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a by-object object search in this collection using a vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/api/graphql/search-operators#nearobject) for a more detailed explanation.
     ...
     * @return {GenerateReturn<T, V, C>} - The results of the search including the generated data.
     */
    nearObject<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(id: string, generate: GenerateOptions<T, C>, opts?: NearOptions<T, V, I>, callOpts?: CallOptions): GenerateReturn<T, RV, C>;
}
interface NearText<T, V> {
     ...
     * @return {Promise<GenerativeReturn<T, V, C>>} - The results of the search including the generated data.
     */
    nearText<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(query: string | string[], generate: GenerateOptions<T, C>, opts?: BaseNearTextOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a by-image object search in this collection using the image-capable vectorization module and vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/api/graphql/search-operators#neartext) for a more detailed explanation.
     ...
     * @return {Promise<GenerativeGroupByReturn<T, V, C>>} - The results of the search including the generated data grouped by the specified properties.
     */
    nearText<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(query: string | string[], generate: GenerateOptions<T, C>, opts: GroupByNearTextOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeGroupByReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a by-image object search in this collection using the image-capable vectorization module and vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/api/graphql/search-operators#neartext) for a more detailed explanation.
     ...
     * @return {GenerateReturn<T, V, C>} - The results of the search including the generated data.
     */
    nearText<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(query: string | string[], generate: GenerateOptions<T, C>, opts?: NearTextOptions<T, V, I>, callOpts?: CallOptions): GenerateReturn<T, RV, C>;
}
interface NearVector<T, V> {
     ...
     * @return {Promise<GenerativeReturn<T, V, C>>} - The results of the search including the generated data.
     */
    nearVector<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(vector: NearVectorInputType, generate: GenerateOptions<T, C>, opts?: BaseNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a by-vector object search in this collection using vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/similarity) for a more detailed explanation.
     ...
     * @return {Promise<GenerativeGroupByReturn<T, V, C>>} - The results of the search including the generated data grouped by the specified properties.
     */
    nearVector<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(vector: NearVectorInputType, generate: GenerateOptions<T, C>, opts: GroupByNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GenerativeGroupByReturn<T, RV, C>>;
    /**
     * Perform retrieval-augmented generation (RaG) on the results of a by-vector object search in this collection using vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/similarity) for a more detailed explanation.
     ...
     * @return {GenerateReturn<T, V, C>} - The results of the search including the generated data.
     */
    nearVector<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>, C extends GenerativeConfigRuntime | undefined = undefined>(vector: NearVectorInputType, generate: GenerateOptions<T, C>, opts?: NearOptions<T, V, I>, callOpts?: CallOptions): GenerateReturn<T, RV, C>;
}
export interface Generate<T, V> extends Bm25<T, V>, Hybrid<T, V>, NearMedia<T, V>, NearObject<T, V>, NearText<T, V>, NearVector<T, V> {
    fetchObjects: <C extends GenerativeConfigRuntime | undefined = undefined>(generate: GenerateOptions<T, C>, opts?: FetchObjectsOptions<T, V>, callOpts?: CallOptions) => Promise<GenerativeReturn<T, V, C>>;
}
export {};
