...
class ConfigMapping {
    ...
    static vectorIndexHFresh(v) {
        if (v === undefined)
            throw new errors_js_1.WeaviateDeserializationError('Vector index was not returned by Weaviate');
        if (!exists(v.distance))
            throw new errors_js_1.WeaviateDeserializationError('Vector index distance was not returned by Weaviate');
        if (!exists(v.maxPostingSizeKB))
            throw new errors_js_1.WeaviateDeserializationError('Vector index maxPostingSizeKb was not returned by Weaviate');
        if (!exists(v.searchProbe))
            throw new errors_js_1.WeaviateDeserializationError('Vector index searchProbe was not returned by Weaviate');
        if (!exists(v.replicas))
            throw new errors_js_1.WeaviateDeserializationError('Vector index replicas was not returned by Weaviate');
        if (!exists(v.rq))
            throw new errors_js_1.WeaviateDeserializationError('Vector index rq was not returned by Weaviate');
        return {
            distance: v.distance,
    ...
    static vectorIndexFlat(v) {
        ...
        if (!exists(v.distance))
            throw new errors_js_1.WeaviateDeserializationError('Vector index distance was not returned by Weaviate');
        let quantizer;
        if (exists(v.bq) && v.bq.enabled === true) {
            quantizer = ConfigMapping.bq(v.bq);
        }
        else if (exists(v.rq) && v.rq.enabled === true) {
            quantizer = ConfigMapping.rq(v.rq);
    ...
    static vectorIndex(v, t) {
        if (t === 'hnsw') {
            ...
            return ConfigMapping.vectorIndexHFresh(v);
        }
        else if (t === 'flat') {
