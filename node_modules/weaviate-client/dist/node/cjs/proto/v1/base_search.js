...
exports.BM25 = exports.NearIMUSearch = exports.NearThermalSearch = exports.NearDepthSearch = exports.NearVideoSearch = exports.NearAudioSearch = exports.NearImageSearch = exports.NearTextSearch_Move = exports.NearTextSearch = exports.NearObject = exports.NearVector_VectorPerTargetEntry = exports.NearVector = exports.Hybrid = exports.SearchOperatorOptions = exports.Selection_MMR = exports.Selection = exports.VectorForTarget = exports.Targets = exports.WeightsForTarget = exports.Hybrid_FusionType = exports.SearchOperatorOptions_Operator = exports.CombinationMethod = exports.protobufPackage = void 0;
...
exports.Selection = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        if (message.mmr !== undefined) {
            exports.Selection_MMR.encode(message.mmr, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.mmr = exports.Selection_MMR.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return { mmr: isSet(object.mmr) ? exports.Selection_MMR.fromJSON(object.mmr) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.mmr !== undefined) {
            obj.mmr = exports.Selection_MMR.toJSON(message.mmr);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        const message = createBaseSelection();
        message.mmr = (object.mmr !== undefined && object.mmr !== null) ? exports.Selection_MMR.fromPartial(object.mmr) : undefined;
        return message;
    },
};
function createBaseSelection_MMR() {
    return { limit: undefined, balance: undefined };
}
exports.Selection_MMR = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
    ...
    create(base) {
        return exports.Selection_MMR.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSelection_MMR();
...
exports.Hybrid = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.selection !== undefined) {
            exports.Selection.encode(message.selection, writer.uint32(114).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 14:
                    ...
                    message.selection = exports.Selection.decode(reader, reader.uint32());
                    continue;
                case 20:
                    if (tag !== 165) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            selection: isSet(object.selection) ? exports.Selection.fromJSON(object.selection) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.selection !== undefined) {
            obj.selection = exports.Selection.toJSON(message.selection);
        }
        if (message.vectorDistance !== undefined) {
    ...
    fromPartial(object) {
        ...
        message.selection = (object.selection !== undefined && object.selection !== null)
            ? exports.Selection.fromPartial(object.selection)
            : undefined;
...
exports.NearVector = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.selection !== undefined) {
            exports.Selection.encode(message.selection, writer.uint32(82).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.NearObject = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.selection !== undefined) {
            exports.Selection.encode(message.selection, writer.uint32(50).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.NearTextSearch = {
    encode(message, writer = minimal_js_1.default.Writer.create()) {
        ...
        if (message.selection !== undefined) {
            exports.Selection.encode(message.selection, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
