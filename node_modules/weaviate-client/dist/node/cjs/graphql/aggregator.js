...
class Aggregator extends commandBase_js_1.CommandBase {
    ...
    withNearImage = (args) => {
        return this.withNearMedia({ ...args, media: args.image, type: nearMedia_js_1.NearMediaType.Image });
    };
    withNearAudio = (args) => {
        return this.withNearMedia({ ...args, media: args.audio, type: nearMedia_js_1.NearMediaType.Audio });
    };
    withNearVideo = (args) => {
        return this.withNearMedia({ ...args, media: args.video, type: nearMedia_js_1.NearMediaType.Video });
    };
    withNearDepth = (args) => {
        return this.withNearMedia({ ...args, media: args.depth, type: nearMedia_js_1.NearMediaType.Depth });
    };
    withNearIMU = (args) => {
        return this.withNearMedia({ ...args, media: args.imu, type: nearMedia_js_1.NearMediaType.IMU });
    };
    withNearText = (args) => {
        if (this.includesNearMediaFilter) {
            throw new Error('cannot use multiple near<Media> filters in a single query');
