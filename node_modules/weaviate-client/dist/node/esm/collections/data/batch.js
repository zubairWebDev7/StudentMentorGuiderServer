...
import { BatchObject as BatchObjectGRPC, BatchReference as BatchReferenceGRPC, BatchStreamRequest, } from '../../proto/v1/batch.js';
...
export const isInternalError = (obj) => {
...
export default function (connection, dbVersionSupport) {
    return {
    ...
    async *generateStreamRequests(grpcMaxMessageSize) {
        ...
        while (true) {
            ...
            if (isBatchObject(entry)) {
                const { grpc } = Serialize.batchObject(entry.collection, entry, false, entry.tenant);
