...
export type VectorIndexConfigType<I> = I extends 'hnsw' ? VectorIndexConfigHNSW : I extends 'flat' ? VectorIndexConfigFlat : I extends 'hfresh' ? VectorIndexConfigHFresh : I extends 'dynamic' ? VectorIndexConfigDynamic : I extends string ? Record<string, any> : never;
...
export type VectorIndexConfig = VectorIndexConfigHNSW | VectorIndexConfigFlat | VectorIndexConfigDynamic | VectorIndexConfigHFresh;
