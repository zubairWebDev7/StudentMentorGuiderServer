...
export type GenerativeConfig = GenerativeAnthropicConfig | GenerativeAnyscaleConfig | GenerativeAWSConfig | GenerativeAzureOpenAIConfig | GenerativeCohereConfig | GenerativeContextualAIConfig | GenerativeDatabricksConfig | GenerativeGoogleConfig | GenerativeFriendliAIConfig | GenerativeMistralConfig | GenerativeOllamaConfig | GenerativeOpenAIConfig | GenerativePaLMConfig | GenerativeXAIConfig | Record<string, any> | undefined;
export type GenerativeConfigType<G> = G extends 'generative-anthropic' ? GenerativeAnthropicConfig : G extends 'generative-anyscale' ? GenerativeAnyscaleConfig : G extends 'generative-aws' ? GenerativeAWSConfig : G extends 'generative-azure-openai' ? GenerativeAzureOpenAIConfig : G extends 'generative-cohere' ? GenerativeCohereConfig : G extends 'generative-contextualai' ? GenerativeContextualAIConfig : G extends 'generative-databricks' ? GenerativeDatabricksConfig : G extends 'generative-google' ? GenerativeGoogleConfig : G extends 'generative-friendliai' ? GenerativeFriendliAIConfig : G extends 'generative-mistral' ? GenerativeMistralConfig : G extends 'generative-ollama' ? GenerativeOllamaConfig : G extends 'generative-openai' ? GenerativeOpenAIConfig : G extends GenerativePalm ? GenerativePaLMConfig : G extends 'generative-xai' ? GenerativeXAIConfig : G extends 'none' ? undefined : Record<string, any> | undefined;
/** @deprecated Use `generative-google` instead. */
type GenerativePalm = 'generative-palm';
export type GenerativeSearch = 'generative-anthropic' | 'generative-anyscale' | 'generative-aws' | 'generative-azure-openai' | 'generative-cohere' | 'generative-contextualai' | 'generative-databricks' | 'generative-google' | 'generative-friendliai' | 'generative-mistral' | 'generative-ollama' | 'generative-openai' | GenerativePalm | 'generative-xai' | 'none' | string;
export {};
