...
interface Bm25<T, V> {
     ...
     */
    bm25<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(query: string, opts?: BaseBm25Options<T, I>, callOpts?: CallOptions): Promise<WeaviateReturn<T, RV>>;
    /**
     * Search for objects in this collection using the keyword-based BM25 algorithm.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/bm25) for a more detailed explanation.
     ...
     */
    bm25<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(query: string, opts: GroupByBm25Options<T, I>, callOpts?: CallOptions): Promise<GroupByReturn<T, RV>>;
    /**
     * Search for objects in this collection using the keyword-based BM25 algorithm.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/bm25) for a more detailed explanation.
     ...
     * @returns {Promise<GroupByReturn<T, V>>} - The result of the search within the fetched collection.
     */
    bm25<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(query: string, opts?: Bm25Options<T, I>, callOpts?: CallOptions): QueryReturn<T, RV>;
}
interface Hybrid<T, V> {
     ...
     */
    hybrid<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(query: string, opts?: BaseHybridOptions<T, V, I>, callOpts?: CallOptions): Promise<WeaviateReturn<T, RV>>;
    /**
     * Search for objects in this collection using the hybrid algorithm blending keyword-based BM25 and vector-based similarity.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/hybrid) for a more detailed explanation.
     ...
     * @returns {Promise<GroupByReturn<T, V>>} - The result of the search within the fetched collection.
     */
    hybrid<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(query: string, opts: GroupByHybridOptions<T, V, I>, callOpts?: CallOptions): Promise<GroupByReturn<T, RV>>;
    /**
     * Search for objects in this collection using the hybrid algorithm blending keyword-based BM25 and vector-based similarity.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/hybrid) for a more detailed explanation.
     ...
     */
    hybrid<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(query: string, opts?: HybridOptions<T, V, I>, callOpts?: CallOptions): QueryReturn<T, RV>;
}
interface NearImage<T, V> {
     ...
     * @returns {Promise<WeaviateReturn<T, V>>} - The result of the search within the fetched collection.
     */
    nearImage<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(image: string | Buffer, opts?: BaseNearOptions<T, V, I>, callOpts?: CallOptions): Promise<WeaviateReturn<T, RV>>;
    /**
     * Search for objects by image in this collection using an image-capable vectorization module and vector-based similarity search.
     * You must have an image-capable vectorization module installed in order to use this method,
     * e.g. `img2vec-neural`, `multi2vec-clip`, or `multi2vec-bind.
     ...
     */
    nearImage<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(image: string | Buffer, opts: GroupByNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GroupByReturn<T, RV>>;
    /**
     * Search for objects by image in this collection using an image-capable vectorization module and vector-based similarity search.
     * You must have an image-capable vectorization module installed in order to use this method,
     * e.g. `img2vec-neural`, `multi2vec-clip`, or `multi2vec-bind.
     ...
     */
    nearImage<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(image: string | Buffer, opts?: NearOptions<T, V, I>, callOpts?: CallOptions): QueryReturn<T, RV>;
}
interface NearMedia<T, V> {
     ...
     * @returns {Promise<WeaviateReturn<T, V>>} - The result of the search within the fetched collection.
     */
    nearMedia<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(media: string | Buffer, type: NearMediaType, opts?: BaseNearOptions<T, V, I>, callOpts?: CallOptions): Promise<WeaviateReturn<T, RV>>;
    /**
     * Search for objects by image in this collection using an image-capable vectorization module and vector-based similarity search.
     * You must have a multi-media-capable vectorization module installed in order to use this method, e.g. `multi2vec-bind` or `multi2vec-palm`.
     *
     ...
     * @returns {Promise<GroupByReturn<T, V>>} - The group by result of the search within the fetched collection.
     */
    nearMedia<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(media: string | Buffer, type: NearMediaType, opts: GroupByNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GroupByReturn<T, RV>>;
    /**
     * Search for objects by image in this collection using an image-capable vectorization module and vector-based similarity search.
     * You must have a multi-media-capable vectorization module installed in order to use this method, e.g. `multi2vec-bind` or `multi2vec-palm`.
     *
     ...
     * @returns {QueryReturn<T, V>} - The result of the search within the fetched collection.
     */
    nearMedia<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(media: string | Buffer, type: NearMediaType, opts?: NearOptions<T, V, I>, callOpts?: CallOptions): QueryReturn<T, RV>;
}
interface NearObject<T, V> {
     ...
     * @returns {Promise<WeaviateReturn<T, V>>} - The result of the search within the fetched collection.
     */
    nearObject<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(id: string, opts?: BaseNearOptions<T, V, I>, callOpts?: CallOptions): Promise<WeaviateReturn<T, RV>>;
    /**
     * Search for objects in this collection by another object using a vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/api/graphql/search-operators#nearobject) for a more detailed explanation.
     ...
     * @returns {Promise<GroupByReturn<T, V>>} - The group by result of the search within the fetched collection.
     */
    nearObject<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(id: string, opts: GroupByNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GroupByReturn<T, RV>>;
    /**
     * Search for objects in this collection by another object using a vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/similarity) for a more detailed explanation.
     ...
     * @returns {QueryReturn<T, V>} - The result of the search within the fetched collection.
     */
    nearObject<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(id: string, opts?: NearOptions<T, V, I>, callOpts?: CallOptions): QueryReturn<T, RV>;
}
interface NearText<T, V> {
     ...
     * @returns {Promise<WeaviateReturn<T, V>>} - The result of the search within the fetched collection.
     */
    nearText<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(query: string | string[], opts?: BaseNearTextOptions<T, V, I>, callOpts?: CallOptions): Promise<WeaviateReturn<T, RV>>;
    /**
     * Search for objects in this collection by text using text-capable vectorization module and vector-based similarity search.
     * You must have a text-capable vectorization module installed in order to use this method,
     * e.g. any of the `text2vec-` and `multi2vec-` modules.
     ...
     * @returns {Promise<GroupByReturn<T, V>>} - The group by result of the search within the fetched collection.
     */
    nearText<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(query: string | string[], opts: GroupByNearTextOptions<T, V, I>, callOpts?: CallOptions): Promise<GroupByReturn<T, RV>>;
    /**
     * Search for objects in this collection by text using text-capable vectorization module and vector-based similarity search.
     * You must have a text-capable vectorization module installed in order to use this method,
     * e.g. any of the `text2vec-` and `multi2vec-` modules.
     ...
     * @returns {QueryReturn<T, V>} - The result of the search within the fetched collection.
     */
    nearText<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(query: string | string[], opts?: NearTextOptions<T, V, I>, callOpts?: CallOptions): QueryReturn<T, RV>;
}
interface NearVector<T, V> {
     ...
     * @returns {Promise<WeaviateReturn<T, V>>} - The result of the search within the fetched collection.
     */
    nearVector<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(vector: NearVectorInputType, opts?: BaseNearOptions<T, V, I>, callOpts?: CallOptions): Promise<WeaviateReturn<T, RV>>;
    /**
     * Search for objects by vector in this collection using a vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/similarity) for a more detailed explanation.
     ...
     * @returns {Promise<GroupByReturn<T, V>>} - The group by result of the search within the fetched collection.
     */
    nearVector<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(vector: NearVectorInputType, opts: GroupByNearOptions<T, V, I>, callOpts?: CallOptions): Promise<GroupByReturn<T, RV>>;
    /**
     * Search for objects by vector in this collection using a vector-based similarity search.
     *
     * See the [docs](https://weaviate.io/developers/weaviate/search/similarity) for a more detailed explanation.
     ...
     * @returns {QueryReturn<T, V>} - The result of the search within the fetched collection.
     */
    nearVector<I extends IncludeVector<V>, RV extends ReturnVectors<V, I>>(vector: NearVectorInputType, opts?: NearOptions<T, V, I>, callOpts?: CallOptions): QueryReturn<T, RV>;
}
...
export interface Query<T, V> extends Bm25<T, V>, Hybrid<T, V>, NearImage<T, V>, NearMedia<T, V>, NearObject<T, V>, NearText<T, V>, NearVector<T, V> {
     ...
     */
    fetchObjectById: <I extends IncludeVector<V>>(id: string, opts?: FetchObjectByIdOptions<T, I>, callOpts?: CallOptions) => Promise<WeaviateObject<T, ReturnVectors<V, I>> | null>;
    /**
     ...
     */
    fetchObjects: <I extends IncludeVector<V>>(opts?: FetchObjectsOptions<T, I>, callOpts?: CallOptions) => Promise<WeaviateReturn<T, ReturnVectors<V, I>>>;
}
