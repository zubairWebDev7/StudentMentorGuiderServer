import { BQConfig, ModuleConfig, MultiVectorConfig, MuveraEncodingConfig, PQConfig, PQEncoderDistribution, PQEncoderType, RQConfig, SQConfig, UncompressedConfig, VectorDistance, VectorIndexConfigDynamic, VectorIndexConfigFlat, VectorIndexConfigHFresh, VectorIndexConfigHNSW, VectorIndexFilterStrategy } from '../../config/types/index.js';
...
export type VectorIndexConfigDynamicUpdate = RecursivePartial<Omit<VectorIndexConfigDynamic, 'hnsw' | 'flat' | 'distance'>> & {
...
export type VectorIndexConfigCreateType<I> = I extends 'hnsw' ? VectorIndexConfigHNSWCreate | undefined : I extends 'flat' ? VectorIndexConfigFlatCreate | undefined : I extends 'dynamic' ? VectorIndexConfigDynamicCreate | undefined : I extends 'hfresh' ? VectorIndexConfigHFreshCreate | undefined : I extends string ? Record<string, any> : never;
...
export type VectorIndexConfigCreate = VectorIndexConfigFlatCreate | VectorIndexConfigHNSWCreate | VectorIndexConfigDynamicCreate | VectorIndexConfigHFreshCreate | Record<string, any> | undefined;
export type VectorIndexConfigUpdate = VectorIndexConfigFlatUpdate | VectorIndexConfigHNSWUpdate | VectorIndexConfigDynamicUpdate | VectorIndexConfigHFreshUpdate | Record<string, any> | undefined;
export type VectorIndexConfigUpdateType<I> = I extends 'hnsw' ? VectorIndexConfigHNSWUpdate : I extends 'flat' ? VectorIndexConfigFlatUpdate : I extends 'dynamic' ? VectorIndexConfigDynamicUpdate : I extends 'hfresh' ? VectorIndexConfigHFreshUpdate : I extends string ? Record<string, any> : never;
