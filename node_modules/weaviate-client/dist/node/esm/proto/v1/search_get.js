    ...
    fromJSON(object) {
        return {
            shards: globalThis.Array.isArray(object?.shards)
                ? object.shards.map((e) => QueryProfile_ShardProfile.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
...
export const QueryProfile_SearchProfile = {
    encode(message, writer = _m0.Writer.create()) {
        Object.entries(message.details).forEach(([key, value]) => {
            QueryProfile_SearchProfile_DetailsEntry.encode({ key: key, value }, writer.uint32(10).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
export const QueryProfile_ShardProfile = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.searches).forEach(([key, value]) => {
            QueryProfile_ShardProfile_SearchesEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
