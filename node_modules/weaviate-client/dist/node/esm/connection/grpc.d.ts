...
export default class ConnectionGRPC extends ConnectionGQL {
    ...
    search: (collection: string, consistencyLevel?: ConsistencyLevel, tenant?: string, abortSignal?: AbortSignal) => Promise<Search>;
...
export interface GrpcClient {
    ...
    search: (collection: string, consistencyLevel?: ConsistencyLevel, tenant?: string, bearerToken?: string, abortSignal?: AbortSignal) => Search;
