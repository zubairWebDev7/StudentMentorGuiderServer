...
import { BatchObject, BatchObjectsReply, BatchStreamReply, BatchStreamRequest } from '../proto/v1/batch.js';
...
export default class Batcher extends Base implements Batch {
    ...
    withStream: (reqs: AsyncGenerator<BatchStreamRequest>) => AsyncGenerator<BatchStreamReply, void, unknown>;
    withDelete: (args: BatchDeleteArgs) => Promise<BatchDeleteReply>;
    withObjects: (args: BatchObjectsArgs) => Promise<BatchObjectsReply>;
    private callStream;
    private callDelete;
