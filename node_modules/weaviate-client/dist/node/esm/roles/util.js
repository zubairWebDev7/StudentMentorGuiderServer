...
export class PermissionGuards {
    ...
    static isMcp = (permission) => PermissionGuards.includes(permission, 'create_mcp', 'read_mcp', 'update_mcp');
...
class PermissionsMapping {
    ...
    mcp = (permission) => {
        if (permission.action === 'create_mcp' ||
            permission.action === 'read_mcp' ||
            permission.action === 'update_mcp') {
            if (this.mappings.mcp[''] === undefined)
                this.mappings.mcp[''] = { actions: [] };
            this.mappings.mcp[''].actions.push(permission.action);
        }
    };
    cluster = (permission) => {
